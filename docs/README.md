...
[![Build Status](https://img.shields.io/jenkins/s/http/jenkins-oss.wixpress.com/job/react-native-navigation-master.svg)](https://jenkins-oss.wixpress.com/job/react-native-navigation-master/)
